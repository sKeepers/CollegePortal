...
- WorkspacePanel используется для основных правых панелей объектов: студенты, преподаватели, группы, дисциплины, аудитории, учебные планы, нагрузка, выпускники, приемная комиссия и цифровые пропуска; правила описаны в `docs/WORKSPACE_GUIDELINES.md`.
