...
const curriculumForm = reactive({ education_program_id: '', name: '', year_start: new Date().getFullYear(), status: 'draft', description: '' })
...
function openCreateForm() { editingCurriculum.value = null; Object.assign(curriculumForm, { education_program_id: '', name: '', year_start: new Date().getFullYear(), status: 'draft', description: '' }); formVisible.value = true }
function openEditForm(curriculum) { editingCurriculum.value = curriculum; Object.assign(curriculumForm, { education_program_id: curriculum.education_program_id, name: curriculum.name, year_start: curriculum.year_start, status: curriculum.status || 'draft', description: curriculum.description || '' }); formVisible.value = true }
