...
const version = computed(() => presentVersionInfo(frontendVersion.value))
      ...
      <template #system>
        <AppCard title="Система" subtitle="Версия, сборка и состояние платформы">
          <dl class="executive-system-list">
            ...
            <div><dt>Дата сборки</dt><dd>{{ version.buildDateLabel }}</dd></div>
            <div><dt>Окружение</dt><dd>{{ version.environmentLabel }}</dd></div>
