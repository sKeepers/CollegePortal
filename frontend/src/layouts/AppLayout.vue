...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Кто сейчас в здании', to: '/access/muster', icon: UsersRound, roles: ['admin', 'director', 'deputy', 'security', 'hr'], permission: 'gate.reports' },
      { label: 'Отчеты по проходам', to: '/access/reports', icon: FileText, roles: ['admin', 'director', 'deputy', 'security', 'hr'], permission: 'gate.reports' },
