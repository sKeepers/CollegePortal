...
UAT Center расширен до центра обработки обращений: карточка обращения, фильтры, поиск, история статусов, комментарии, просмотр private-скриншота и ручная связь с GitHub Issue. Следующие этапы: SLA, уведомления, назначение ответственных групп и автоматическая GitHub-интеграция после отдельного решения.
