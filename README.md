...
```bash
tar -xzf college-portal-0.8.0-rc9.tar.gz
cd college-portal-0.8.0-rc9
...
```bash
sudo /opt/college-portal/installer/update.sh college-portal-0.8.0-rc9.tar.gz
sudo /opt/college-portal/installer/check.sh
```
...
Release: [v0.8.0-rc9](https://github.com/sKeepers/CollegePortal/releases/tag/v0.8.0-rc9)
