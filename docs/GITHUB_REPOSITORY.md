...
The current release tag is `v0.8.0-rc9`. Release notes live in `CHANGELOG.md`; the release archive is built on DEV by `scripts/release/build-release.sh` and must be reviewed before being attached as a release asset.
