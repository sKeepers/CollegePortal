...
3. Нагрузка преподавателя:
   ...
   - текущий известный результат: `403` до загрузки данных, поскольку endpoint требует `teachingload.view`. Это дефект UAT, а не основание выдавать teacher административное permission.
4. Доказательства:
