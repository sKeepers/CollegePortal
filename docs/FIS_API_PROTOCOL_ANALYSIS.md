...
Протокол не реализован на основании догадок — это правило в силе и сегодня.

Строка «спецификация и XSD пока не загружены» устарела: **и спецификация 4.9, и официальная XSD лежат в репозитории** — `docs/external-services/ФИС ГИА и Приема/`, рабочая копия схемы в `backend/resources/fis/gia-priem/4.9/`. Скачать их с `priem.rustest.ru` с DEV по-прежнему нельзя, но искать их там больше незачем.
