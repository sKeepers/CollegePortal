...
- [Печать дипломов на бланках гознака](DIPLOMA_PRINTING.md) — что можно печатать сегодня, чего нет и что нужно от владельца
- [Электронное личное дело студента](STUDENT_PERSONAL_FILE.md) — что портал хранит, чего требует ФРДО и архивное дело, чего нет ни в одном источнике
- [Лист сверки контингента для учебной части](CONTINGENT_CHECKLIST_FOR_STUDY_OFFICE.md) — 31 карточка с вопросами по номеру личного дела: что проверить по бумагам
- [Буква «А» и «Б» в названии группы](GROUP_LETTER_AND_FUNDING.md) — это не деление на группы, а источник оплаты; куда он перенесён и почему 329 карточек остались пустыми
...
- [Протокол CARDDEX по снимку обмена](CARDDEX_PROTOCOL.md) — UDP 7001, кадр и контрольная сумма (сошлась на всех 35 064 кадрах), запись события с временем и номером карты, две стороны турникета; и чего в снимке нет — команд управления
...
- [Преподаватель видит своё: дисциплины, группы, студенты](TEACHER_SEES_ONLY_THEIR_OWN.md) — разбор до кода: почему нельзя выдать существующее право (у `students.view` десять ролей), откуда берётся «своё» и что должен сказать экран, пока расписания нет
...
- [MOB_003_FIELD_CHECKS.md](MOB_003_FIELD_CHECKS.md)
...
- [NOTIFY_PARENTS_QUESTIONS.md](NOTIFY_PARENTS_QUESTIONS.md)
- [SERVER_IP_CHANGE.md](SERVER_IP_CHANGE.md)
...
- [SESSION_HANDOFF_2026-08-17.md](SESSION_HANDOFF_2026-08-17.md)
