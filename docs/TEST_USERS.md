...
| Куратор | `curator@local` | `curator` | служебная; заведена 11.08.2026 — роль держала права мобильных кабинетов, а учётной записи под неё не было, и обход прав эту роль не проверял |
