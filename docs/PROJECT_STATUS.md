...
Текущий релиз — `0.8.0-rc7`, тег `v0.8.0-rc7`, установлен на PROD `https://portal.skki.ru`. Единственный источник истины о номере версии — `installer/VERSION`; в остальных документах номер допустим только в примерах команд и в исторических записях.
