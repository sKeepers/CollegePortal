...
- Все ответы пользователю, планы, отчеты, документация, UAT-сценарии и пользовательский текст писать на русском языке.
- Английский сохраняется только для неизменяемых технических идентификаторов: команд, путей, URL, API endpoints, названий классов, переменных, Git branch/commit и официальных внешних терминов.
