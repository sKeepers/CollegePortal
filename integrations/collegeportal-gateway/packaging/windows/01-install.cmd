...
sc query CollegePortalGateway >nul 2>&1 || sc create CollegePortalGateway binPath= "\"%ROOT%\bin\CollegePortal.Gateway.Host.exe\" --config \"%ROOT%\config\gateway.private.config\"" start= demand
