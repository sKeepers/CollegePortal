...
class FisOutboundPackage extends Model
{
    ...
    protected $fillable = ['package_type','external_campaign_id','admission_year','source_entity_type','source_entity_id','schema_version','environment','status','payload_path','payload_sha256','package_id','request_id','created_by','validated_at','sent_at','accepted_at','completed_at','failed_at','retry_count','last_error_code','last_error_message','response_metadata'];

    protected function casts(): array
    {
        return ['response_metadata' => 'array', 'admission_year' => 'integer', 'validated_at' => 'datetime', 'sent_at' => 'datetime', 'accepted_at' => 'datetime', 'completed_at' => 'datetime', 'failed_at' => 'datetime', 'retry_count' => 'integer'];
    }
