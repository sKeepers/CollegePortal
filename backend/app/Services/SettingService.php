...
class SettingService
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'organization' => [
                'full_name' => ['value' => 'Государственное бюджетное профессиональное образовательное учреждение', 'type' => 'string', 'is_public' => false, 'label' => 'Полное наименование организации', 'description' => 'Используется в официальных печатных формах.'],
                'short_name' => ['value' => 'Колледж', 'type' => 'string', 'is_public' => false, 'label' => 'Краткое наименование организации', 'description' => 'Используется в справках и проверке документов.'],
                'department_name' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'Ведомственная принадлежность', 'description' => 'Учредитель или ведомство.'],
                'address' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'Адрес организации', 'description' => 'Почтовый адрес для официальных документов.'],
                'phone' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'Телефон организации', 'description' => 'Контактный телефон для справок.'],
                'email' => ['value' => '', 'type' => 'email', 'is_public' => false, 'label' => 'Email организации', 'description' => 'Официальная почта.'],
                'website' => ['value' => '', 'type' => 'url', 'is_public' => false, 'label' => 'Сайт организации', 'description' => 'Официальный сайт.'],
                'inn' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'ИНН', 'description' => 'Реквизит организации.'],
                'kpp' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'КПП', 'description' => 'Реквизит организации.'],
                'ogrn' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'ОГРН', 'description' => 'Реквизит организации.'],
                'head_full_name' => ['value' => '', 'type' => 'string', 'is_public' => false, 'label' => 'ФИО руководителя', 'description' => 'Подписант справок.'],
                'head_position' => ['value' => 'Руководитель', 'type' => 'string', 'is_public' => false, 'label' => 'Должность руководителя', 'description' => 'Должность подписанта справок.'],
            ],
            'academic' => [
