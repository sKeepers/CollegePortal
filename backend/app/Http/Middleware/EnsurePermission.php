...
class EnsurePermission
{
    ...
    private function domainPermission(string $path, string $method): string
    {
        $rules = [
            ...
            'api/access/token' => ['access.view', 'access.view', 'access.view', 'access.view'],
            'api/access/scan' => ['access.scan', 'access.scan', 'access.scan', 'access.scan'],
            'api/access/events' => ['access.view', 'access.override', 'access.override', 'access.manage'],
            'api/access/points' => ['access.view', 'access.manage', 'access.manage', 'access.manage'],
            'api/access/devices' => ['access.manage', 'access.scan', 'access.manage', 'access.manage'],
