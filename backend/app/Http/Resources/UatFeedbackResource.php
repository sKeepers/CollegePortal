...
class UatFeedbackResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'github_issue_status' => $this->github_issue_status,
            'status_history' => UatFeedbackStatusHistoryResource::collection($this->whenLoaded('statusHistory')),
            'comments' => UatFeedbackCommentResource::collection($this->whenLoaded('comments')),
