...
class ImportCertificateRegister extends Command
{
    ...
    {
        // В бумажной книге рядом с фамилией пишут уточнение в скобках —
        // прежнюю фамилию или пометку: «Фамилия Имя Отчество (Прежняя)».
        // В карточке студента скобок не бывает, поэтому строка не сходилась
        // и справка ложилась в реестр без студента. Замер вечером 01.09.2026 на
        // рабочем реестре: 86 строк из 591 не находили человека, снятие
        // скобок вернуло 85, и ни одна из них не стала неоднозначной.
        // Само уточнение из `full_name` не убирается: в книге оно написано,
        // и печатный реестр обязан повторять книгу.
