...
class AdmissionReferenceCatalogs
{
    ...
    public static function catalogs(): array
    {
        return [
            ...
            self::catalog('admission_identity_document_types', 'Типы документов, удостоверяющих личность', 'Foundation-справочник типов документов личности с подготовкой к ФИС mapping.', [
                ['russian_passport', 'Паспорт гражданина РФ', ['fis_reference' => 'IdentityDocumentTypeID']],
                ['birth_certificate', 'Свидетельство о рождении', ['fis_reference' => 'IdentityDocumentTypeID']],
                ['foreign_identity', 'Иностранный документ', ['fis_reference' => 'IdentityDocumentTypeID']],
                ['temporary_identity', 'Временное удостоверение личности', ['fis_reference' => 'IdentityDocumentTypeID']],
                ['other_identity', 'Иной документ', ['fis_reference' => 'IdentityDocumentTypeID']],
            ]),
            self::catalog('admission_education_document_types', 'Типы документов об образовании', 'Foundation-справочник типов документов об образовании с подготовкой к XSD ФИС.', [
                ['basic_general_certificate', 'Аттестат об основном общем образовании', ['fis_type' => 'TSchoolCertificateDocument']],
                ['secondary_general_certificate', 'Аттестат о среднем общем образовании', ['fis_type' => 'TSchoolGeneralCertificateDocument']],
                ['spo_diploma', 'Диплом СПО', ['fis_type' => 'TMiddleEduDiplomaDocument']],
                ['npo_diploma', 'Диплом НПО', ['fis_type' => 'TBasicDiplomaDocument']],
                ['foreign_education_document', 'Иностранный документ об образовании', ['fis_type' => 'TForeignStateEduDocument']],
                ['academic_certificate', 'Академическая справка', ['fis_type' => 'TAcademicDiplomaDocument']],
                ['other_education', 'Иной документ об образовании', ['fis_type' => 'TEduCustomDocument']],
            ]),
            self::catalog('admission_document_verification_statuses', 'Статусы проверки структурированных документов', 'Статусы проверки реквизитов документа, отдельные от статуса файла.', [
                ['received', 'Получен', ['tone' => 'info']],
                ['pending_review', 'Ожидает проверки', ['tone' => 'warning']],
                ['verified', 'Проверен', ['tone' => 'success']],
                ['rejected', 'Отклонён', ['tone' => 'danger']],
                ['replacement_required', 'Требует замены', ['tone' => 'warning']],
                ['archived', 'Архивирован', ['tone' => 'neutral']],
            ]),
            self::catalog('admission_document_file_categories', 'Категории файлов документов абитуриента', 'Типы образов документа в private storage.', [
                ['main_spread', 'Основной разворот'],
                ['registration', 'Регистрация'],
                ['attachment', 'Приложение'],
                ['front_side', 'Первая сторона'],
                ['back_side', 'Вторая сторона'],
                ['other', 'Другое'],
            ]),
            ...
            self::catalog('education_levels', 'Уровни образования', 'Уровни образования для документов абитуриента.', [
                ['basic_general', 'Основное общее образование'],
                ['secondary_general', 'Среднее общее образование'],
                ['secondary_vocational', 'Среднее профессиональное образование'],
