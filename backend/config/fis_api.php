...
return [
    ...
    'transport' => env('FIS_API_TRANSPORT', 'xml_http'),
    'protocol' => 'xml_over_http',
    'http_method' => 'POST',
    'content_type' => env('FIS_API_CONTENT_TYPE', 'application/xml; charset=UTF-8'),
    'read_only_operation' => env('FIS_API_READ_ONLY_OPERATION', 'GetTestDictionariesList'),
    'enable_mutating_operations' => (bool) env('FIS_API_ENABLE_MUTATING_OPERATIONS', false),
    'gateway_url' => env('FIS_GATEWAY_URL'),
    'gateway_diagnostics_url' => env('FIS_GATEWAY_DIAGNOSTICS_URL', env('FIS_GATEWAY_URL')),
    ...
    'spec_registry_path' => env('FIS_API_SPEC_REGISTRY_PATH', storage_path('app/private/fis-specs/4.9')),
    ...
    'contract_verified' => (bool) env('FIS_API_CONTRACT_VERIFIED', false),
    'authentication_confirmed' => (bool) env('FIS_API_AUTHENTICATION_CONFIRMED', false),
    'confirmed_read_only_operations' => array_values(array_filter(array_map(
        'trim',
        explode(',', (string) env('FIS_API_CONFIRMED_READ_ONLY_OPERATIONS', '')),
    ))),
];
