...
class MenuMatchesPermissionsTest extends TestCase
{
    ...
    private const SECTION_REQUESTS = [
        ...
        // «Общежитие» видно **двум** ролям: коменданту и заместителю по
        // воспитательной работе. Права у них разные — оплаты у заместителя
        // нет вовсе, и вкладки он не видит. Поэтому сюда идут только те
        // запросы, которые обязаны открыться у **каждого**, кому раздел
        // показан: сводка, места, заселение и ночные отсутствия. Впиши сюда
        // оплату — и проверка стала бы падать на разнице обязанностей, а не
        // на ошибке.
        'Общежитие' => ['dorm/today', 'dorm/rooms', 'dorm/placements', 'dorm/absences'],
        // Второй контур: провинности и социальный паспорт. Коменданта тут
        // нет вовсе, и это его собственное право, а не отсутствие экрана.
        'Воспитательная работа' => ['dorm/upbringing/today', 'dorm/conduct', 'dorm/social'],
