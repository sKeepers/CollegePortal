...
use App\Http\Controllers\Api\StudentContingentImportController;
...
Route::middleware('api.token')->group(function (): void {
    ...
    Route::middleware('permission:manage_dictionaries')->group(function (): void {
        ...
        Route::post('admin/import/student-contingent/analyze', [StudentContingentImportController::class, 'analyze'])->middleware('permission:students.import_contingent');
        Route::post('admin/import/student-contingent/dry-run', [StudentContingentImportController::class, 'dryRun'])->middleware('permission:students.import_contingent');
        Route::post('admin/import/student-contingent/apply', [StudentContingentImportController::class, 'apply'])->middleware('permission:students.import_contingent_apply');
        Route::get('admin/import/student-contingent/jobs/{importJob}', [StudentContingentImportController::class, 'show'])->middleware('permission:students.import_contingent_review');
        Route::get('admin/import/student-contingent/jobs/{importJob}/review', [StudentContingentImportController::class, 'review'])->middleware('permission:students.import_contingent_review');
