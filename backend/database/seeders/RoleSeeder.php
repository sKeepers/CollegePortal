...
class RoleSeeder extends Seeder
{
    ...
    private function permissions(): array
    {
        return [
            ...
            ['module' => 'Documents', 'code' => 'documents.view', 'name' => 'Документы: просмотр', 'description' => 'Просмотр подсистемы печатных форм и журнала документов.'],
            ['module' => 'Documents', 'code' => 'documents.create', 'name' => 'Документы: создание', 'description' => 'Создание preview документа.'],
            ['module' => 'Documents', 'code' => 'documents.generate', 'name' => 'Документы: формирование', 'description' => 'Формирование официального документа.'],
            ['module' => 'Documents', 'code' => 'documents.issue', 'name' => 'Документы: выдача', 'description' => 'Отметка документа как выданного.'],
            ['module' => 'Documents', 'code' => 'documents.cancel', 'name' => 'Документы: отмена', 'description' => 'Отмена выданного или сформированного документа.'],
            ['module' => 'Documents', 'code' => 'documents.reprint', 'name' => 'Документы: повторная печать', 'description' => 'Фиксация повторной печати без нового номера.'],
            ['module' => 'Documents', 'code' => 'documents.download_docx', 'name' => 'Документы: скачать DOCX', 'description' => 'Скачивание DOCX из private storage.'],
            ['module' => 'Documents', 'code' => 'documents.download_pdf', 'name' => 'Документы: скачать PDF', 'description' => 'Скачивание PDF из private storage.'],
            ['module' => 'Documents', 'code' => 'documents.export', 'name' => 'Документы: экспорт журнала', 'description' => 'Экспорт журнала документов без лишних персональных данных.'],
            ['module' => 'Documents', 'code' => 'documents.templates.view', 'name' => 'Шаблоны документов: просмотр', 'description' => 'Просмотр шаблонов документов.'],
            ['module' => 'Documents', 'code' => 'documents.templates.manage', 'name' => 'Шаблоны документов: управление', 'description' => 'Создание и загрузка draft-шаблонов.'],
            ['module' => 'Documents', 'code' => 'documents.templates.publish', 'name' => 'Шаблоны документов: публикация', 'description' => 'Публикация активной версии шаблона.'],
            ['module' => 'Documents', 'code' => 'documents.types.manage', 'name' => 'Типы документов: управление', 'description' => 'Будущее управление типами документов.'],
            ['module' => 'Documents', 'code' => 'documents.verify_private', 'name' => 'Документы: внутренняя проверка', 'description' => 'Расширенная проверка документов сотрудником.'],
            ['module' => 'Documents', 'code' => 'documents.view_sensitive_data', 'name' => 'Документы: чувствительные данные', 'description' => 'Просмотр чувствительных данных в preview при наличии права.'],
    ...
    private function directorPermissions(): array
    {
        return [
            ...
            'frdo.view', 'fis.view', 'fis.outbound.view', 'fis.outbound.status', 'documents.view', 'documents.templates.view', 'documents.download_docx', 'documents.download_pdf', 'documents.verify_private', 'gate.reports', 'audit.view', 'reference.manage', 'uat.manage', 'hr.employees.view', 'hr.calendar.view', 'hr.replacements.view', 'hr.reports.view', 'view_reports',
        ];
    }
    ...
    private function academicEditorPermissions(): array
    {
        return [
            ...
            'attendance.view', 'attendance.reports', 'admissions.documents.view', 'documents.view', 'documents.create', 'documents.generate', 'documents.issue', 'documents.cancel', 'documents.reprint', 'documents.download_docx', 'documents.download_pdf', 'documents.export', 'documents.templates.view', 'documents.verify_private', 'documents.view_sensitive_data', 'curricula.view', 'curricula.edit', 'curricula.subjects.view', 'curricula.subjects.create', 'curricula.subjects.update', 'curricula.subjects.delete',
