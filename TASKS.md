...
- [ ] Перенести раздел «Преподаватели» в новый Quasar GUI по образцу GUI-004
- [ ] Карточка абитуриента с подробностями справа или в модальном окне
- [ ] Перенести редактирование документов из строки таблицы в карточку абитуриента
- [ ] Приемные кампании и конкурсные группы
- [ ] Приказы о зачислении
- [ ] Расширенная карточка студента для будущего ФРДО
- [ ] Справочники внешних кодов для ФРДО и ФИС ГИА/Приема
- [ ] Журнал обмена с внешними сервисами
