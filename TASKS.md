...
- [x] Провести аудит существующего `uat_feedback` flow.
- [x] Добавить карточку обращения в `/admin/uat`.
- [x] Использовать существующий private screenshot endpoint для просмотра и скачивания.
- [x] Добавить историю изменения статусов.
- [x] Добавить комментарии администратора, разработчика и тестировщика.
- [x] Добавить фильтры по статусу, категории, важности, автору, странице, периоду и версии.
- [x] Добавить поиск по обращениям.
- [x] Добавить копирование ссылки на обращение.
- [x] Подготовить поля связи с GitHub Issue без автоматической интеграции.
