...
- [ ] AUTH-004: вход через MAX. Первый шаг — подтвердить наличие официального публичного API авторизации.

Требование безопасности для AUTH-003 и AUTH-004: вход через мессенджер только привязывается к существующей учётной записи и никогда не создаёт новую.
