...
- [x] DOCS-001: создать единый центр управления документацией проекта.
- [ ] DOCS-002: актуализировать документацию и устранить подтвержденные противоречия без изменений кода.
## Сначала
