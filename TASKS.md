...
- [x] MOB-001: мобильный кабинет преподавателя. Сделано 10.08.2026, `01b1ed77d`: свои занятия на день и неделю, состояние журнала по каждому, отметка посещаемости и оценки в один экран без горизонтальной прокрутки, свой QR-пропуск. Остаётся право `mobile.teacher.view` — ждёт `ARCH-001`.
