...
- [ ] DORM-001: модуль общежития. Предложен владельцем 11.08.2026, объём не определён — первый шаг разбор и вопросы, не код. Известно: общежитие на Серова, 277 заводится третьим корпусом с одной точкой прохода, в нём есть учебные кабинеты, появляются две новые роли — комендант общежития и заместитель директора по воспитательной работе. Права обеих ролей заводятся миграцией, а не только сидером. Реальные ФИО сотрудников в репозиторий не переносятся: они заводятся в системе через кадры.
